...
Furthermore, because this extension is relevant only to Youtube, I decided it was important to stay consistent with youtubes styling.


# [Coffee Maker](https://github.com/Lliam-Rankins/Coffee_Maker)
School Project to help improve our team work on a semester long project. This project utilized basic tools such as HTML, CSS, JavaScript, as well as more complex tool like REST API, MySQL. It also taught us how to use Github Actions, and general design frameworks such as AGILE.

## Design Reasoning
This project was focused on expanding our skill sets, and giving us practice in real word design philosophies. For example, we typically followed a pattern of planning a design/change of design, implementing the change, testing the change, and 'releasing' it. This led to a lot of refactoring, design sketches, team discussion, and overall improvment of the product.
...
RenPy is a game engine specifically built for visual novels, and as such has many accessibility needs baked into the engine. Further more the design process is signifigantly simplier, allowing for a more complete game. However, due to the new nature of the platform and length of game script, using Git alone for colaborative work would have caused problems. As such we wrote the novel script in google docs, and I created a Python tool to translate the markdown file downloaded from google docs, and translate it into fully usable code files for the game engine. This signifigantly shortened development time and helped to reduce errors in the final product.
